...
class IndustryGraduate extends Graduate implements IEmployee {
    ...
    public IndustryGraduate(String name, int year, String professor, String address, String major, String company,
            String department, String position) {
        super(name, year, professor, address, major);
    ...
    @Override
    public String toString() {
        return "IndustryGraduate [course=graduate" + ", name=" + name + ", year=" + year + ", professor=" + professor
                + ", address=" + address + ", major=" + major + ", company=" + Company() + ", department="
